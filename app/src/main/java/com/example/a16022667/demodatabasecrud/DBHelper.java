package com.example.a16022667.demodatabasecrud;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private  static final String COLUMN_MODULE_NAME = "module_code";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        for(int i = 0; i < 4; i++){
            ...
            values.put(COLUMN_NOTE_CONTENT, "Data member " + i);
            db.insert(TABLE_NOTE,null,values);
        }
        Log.i("info","dummmy records inserted");
    }
